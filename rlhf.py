...
sft_model_name = "theblackcat102/pythia-3b-deduped-sft"
dataset_name = "chip2_instruct_alpha_v6a_4.json" #Currently only set up to work with rallio's data format; for more info on these look here: https://github.com/LAION-AI/Open-Instruction-Generalist
dataset2_name = "en_100_tree.jsonl"
max_tokens = 400
...
with open('configs/ppo_config_summ_gptj.yml') as f:
